...
export const getPosts=(req,res)=>{
    ...
    jwt.verify(token,"secretkey",(err,userInfo)=>{
        ...
        :`SELECT p.*,u.user_id AS user_id,name,profile_pic FROM posts AS p JOIN users AS u ON (u.user_id=p.user_id) JOIN relationships AS r ON (p.user_id= r.followed_userid) WHERE r.follower_userid= ? OR p.user_id = ? ORDER BY p.created_at DESC`
